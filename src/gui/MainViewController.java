...
public class MainViewController implements Initializable {
	...
	private synchronized void loadView2(String absoluteName) { // parametro recebe o caminho da view principal
		try {
			...
			controller.setDepartmentServices(new DepartmentServices()); //para gerar dependencia com a classe DepartmentServices 
